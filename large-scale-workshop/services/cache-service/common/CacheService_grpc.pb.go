...
func (c *cacheServiceClient) Delete(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (UnimplementedCacheServiceServer) Delete(context.Context, *DeleteRequest) (*empty.Empty, error) {
