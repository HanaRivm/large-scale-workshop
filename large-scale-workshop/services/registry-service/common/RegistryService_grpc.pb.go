...
const (
	...
	RegistryService_Unregister_FullMethodName = "/registry.RegistryService/Unregister"
	RegistryService_Discover_FullMethodName   = "/registry.RegistryService/Discover"
	RegistryService_IsAlive_FullMethodName    = "/registry.RegistryService/IsAlive"
)
...
func (c *registryServiceClient) Discover(ctx context.Context, in *DiscoverRequest, opts ...grpc.CallOption) (*DiscoverResponse, error) {
	...
	err := c.cc.Invoke(ctx, RegistryService_Discover_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
